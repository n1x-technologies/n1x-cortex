...
#set page(
  ...
  header: [
    ...
    #grid(columns: (1fr, auto))[
      #text(fill: sd-navy, weight: "bold")[N1X Cortex — Metodología de Gestión del Conocimiento]
    ][
      #text(fill: sd-mid)[N1X Technologies · v2.0 · Junio 2026]
    ]
    #v(-4pt)
...
#page(margin: 0pt, header: none, footer: none, numbering: none)[
  ...
  #block(fill: white, width: 100%, inset: (x: 3cm, top: 2.5cm, bottom: 2cm))[
    ...
    #grid(columns: (1fr, 1fr, 1fr), gutter: 20pt)[
      ...
      #text(size: 10.5pt, fill: sd-navy)[2.0 · Junio 2026]
    ][
    ...
    #line(length: 100%, stroke: 0.5pt + sd-divider)
    #v(0.5cm)
    #text(size: 8pt, fill: sd-mid)[© 2026 N1X Technologies — Todos los derechos reservados]
  ]
]
...
#page[
  ...
  #toc-item("01", "Qué es N1X Cortex", "Definición, el problema que resuelve")
  ...
  #toc-item("09", "Autoría e IP", "© 2026 N1X Technologies")
]

// ═════════════════════════════════════════════════════════════════════════════
// 01 — QUÉ ES N1X CORTEX
// ═════════════════════════════════════════════════════════════════════════════
= 01 — Qué es N1X Cortex
...
#callout[
  N1X Cortex convierte esa masa documental en una *red de nodos atómicos*: una nota por concepto, una nota por regla, una nota por flujo. Todos interconectados con enlaces semánticos y etiquetados con frontmatter estructurado.
]
...
N1X Cortex incluye un pipeline para convertir el conocimiento acumulado en documentos PDF entregables — con identidad visual consistente, atribución de autoría y trazabilidad a las notas fuente. Es un método reproducible, no un diseño ad-hoc por documento.
...
A modo de ejemplo *hipotético* — no corresponde a ningún cliente ni proyecto real — considérese la aplicación de N1X Cortex a un proyecto de integración en un sector regulado de alta densidad documental.
