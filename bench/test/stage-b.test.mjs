...
describe('runStageB', () => {
  ...
  // The answerable half now has to model ABSTAINED too — abstention moved into
  // the judge prompt and is no longer short-circuited before the call. Bare
  // refusals only: a decline followed by a figure is graded on the figure, on
  // both paths.
  const bothJudge = {
