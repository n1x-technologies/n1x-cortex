...
// ───────────────────────────────────────────────────────────────────
// Professional document template parameterizable by brand.
...
// ── Components ─────────────────────────────────────────────────────
#let yes = text(fill: primary, weight: "bold")[Yes]
...
#let doc(
  ...
  let header-right = if client != "" { "For " + client + " · " + classification } else { classification }
    ...
    #block(fill: primary, width: 100%, height: 100%)[
      ...
      #pad(left: 3cm, right: 3cm, top: 3.5cm)[
        ...
        #grid(columns: (1fr, 1fr, 1fr), gutter: 0pt,
          [#text(size: 8.5pt, fill: secondary.darken(35%))[FOR] #v(3pt) #text(size: 11pt, weight: "bold")[#para-field]],
          [#text(size: 8.5pt, fill: secondary.darken(35%))[DOCUMENT] #v(3pt) #text(size: 11pt, weight: "bold")[#doc-label]],
          [#text(size: 8.5pt, fill: secondary.darken(35%))[DATE] #v(3pt) #text(size: 11pt, weight: "bold")[#date-field]],
        )
        #v(0.6em)
        #line(length: 100%, stroke: 0.5pt + primary.lighten(25%))
        #v(0.8em)
        #grid(columns: (1fr, 1fr, 1fr), gutter: 0pt,
          [#text(size: 8.5pt, fill: secondary.darken(35%))[CLASSIFICATION] #v(3pt) #text(size: 11pt, weight: "bold")[#classification]],
          [#text(size: 8.5pt, fill: secondary.darken(35%))[PREPARED BY] #v(3pt) #text(size: 11pt, weight: "bold")[#brand-name]],
          [#text(size: 8.5pt, fill: secondary.darken(35%))[VERSION] #v(3pt) #text(size: 11pt, weight: "bold")[#version]],
        )
      ]
    ]
  ]
