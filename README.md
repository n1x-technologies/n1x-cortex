...
- **Roadmap:** Phase 1 — local web viewer (graph + search) · Phase 2 — cited query · Phase 3 — assisted atomization · Phase 4 — autonomy hooks. The full design lives in [`docs/superpowers/specs/`](docs/superpowers/specs/) and the build plan in [`docs/superpowers/plans/`](docs/superpowers/plans/).
