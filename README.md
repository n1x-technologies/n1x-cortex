...
| `cortex viz` | Local web viewer: interactive graph in a branded sidebar — search, color-by, animated focus, neighbor highlighting, a bidirectional (in/out) link panel, and a tri-state group filter. |
