...
- **Roadmap:** Phase 0 (engine + CLI) ✓ · Phase 1 (web viewer) ✓ · Phase 2 (cited query) ✓ · Phase 3 (assisted atomization) ✓ · Phase 3.1 (AI-distilled notes) ✓ · Phase 3.2 (autonomous update/merge) ✓ · Phase 3.3 (autonomous promote) ✓ · Phase 4 ✓ — Autonomy hooks (detect-and-suggest), all five lifecycle events: SessionStart · Stop · PostToolUse · UserPromptSubmit · SessionEnd, plus kill switch; auto-write deferred. The full design lives in [`docs/superpowers/specs/`](docs/superpowers/specs/) and the build plans in [`docs/superpowers/plans/`](docs/superpowers/plans/).
